  ...
  "locations": [ //y,x
    {
	  ...
	  <ul>\
		  ...
		  <li style='color:#A38B6D;'>Присутствует дилижанс</li>\
		  <li style='color:#A38B6D;'>Присутствует рынок</li>\
	  </ul>",
    ...
    },
    {
	  ...
	  <ul>\
		  <li style='color:#4CAF50;'>Опасность: безопасно</li>\
		  <li style='color:#A38B6D;'>Присутствует паромщик</li>\
		  <li style='color:#A38B6D;'>Присутствует лавка</li>\
	  </ul>",
    ...
    },
    {
	  ...
	  <ul>\
		  ...
		  <li style='color:#A38B6D;'>Присутствует продажа комнат для отдыха</li>\
		  <li style='color:#A38B6D;'>Заниженные требования контингента к \"параметрам тела\"</li>\
	  </ul>",
    ...
    },
    {
      ...
      "description": "<p>Рынок Ноэртауна. Много ширпотребных товаров.</p>\
	  <ul>\
		  <li style='color:#4CAF50;'>Опасность: безопасно</li>\
		  <li style='color:#A38B6D;'>Присутствует множество лавок</li>\
	  </ul>",
    ...
    },
    {
	  ...
	  <ul>\
		  <li style='color:#4CAF50;'>Опасность: безопасно</li>\
		  <li style='color:#A38B6D;'>Это даже не локация, просто ивент для взаимодействия, который вызывает диалог по заданию.</li>\
	  </ul>",
    ...
    },
    {
	  ...
	  <ul>\
		  <li style='color:#4CAF50;'>Опасность: безопасно</li>\
		  <li style='color:#A38B6D;'>Присутствует транс</li>\
	  </ul>",
